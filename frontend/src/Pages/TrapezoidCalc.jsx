...
const TrapezoidCalc = () => {
  ...
  const handleSubmit = (event) => {
    axios.post("https://api-mathemagics.herokuapp.com/trapezoid/", data).then((res)=>{setAnswer(res.data)})
    console.log(data)
    console.log(answer)
    event.preventDefault()
    ...
    <>
      ...
      <div className="flex">
        ...
        <div className=" w-1/2 mt-12 mr-20 flex flex-col text-white">
          <p className="mt-24 ml-10 font-normal text-2xl flex">Based on Trapezoid Rule's:<Newton className="ml-10 -mt-5"/></p>
